...
import { NOT_COMPUTABLE, formatPercent } from './format'
...
/**
 * The annual fiscal estimate, with the word «stima» at the head of the page.
 *
...
export function FiscalPanel() {
  ...
  const estimate = useFiscalEstimate(year)
