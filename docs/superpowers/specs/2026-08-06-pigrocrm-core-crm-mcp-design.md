...
the previous system resta in produzione durante lo sviluppo. **Non c'è importer Attio nello slice 1**: importare su un modello dati ancora in movimento significa farlo due volte. L'importer è previsto nello slice 2, a modello stabilizzato.
