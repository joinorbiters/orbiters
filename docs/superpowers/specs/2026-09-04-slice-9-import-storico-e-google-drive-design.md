...
|---|---|---|
| `importata_da` | `String(20)` null | `'acme'` per questo slice. `NULL` = emessa da PigroCRM. È il campo che dice «di questa fattura il CRM non ha prodotto né XML né PDF» |
...
note_interne?, importata_da: "acme"
```
