...
Acme kept this in a JSON file with a non-atomic read-modify-write, so two concurrent
...
class EmailDraftService:
    ...
    def delete(self, draft_id: UUID, actor: Actor) -> None:
        ...
        which is Acme's «404 Offerta non trovata per registrare l'invio email» with the
