...
This is the file for Acme's live defect: it sends, then fails to write the record, then
...
def _lost_answer(deliver: bool, **overrides: Any) -> FakeGmail:
    ...
    really did leave, and only the response was lost. That is Acme's live defect, and it
