"""One small token bucket per client, shared by every public write of the hub.

There is no limiter anywhere else in this API (nothing else is unauthenticated), so this
is the one that exists, and it is deliberately tiny rather than a dependency. It came
with the signup route from PigroCRM on 2026-09-09 and grew two more callers.
"""
