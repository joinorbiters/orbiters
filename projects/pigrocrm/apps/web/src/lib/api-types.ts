...
export interface paths {
    ...
    "/api/documents/{document_id}/testo": {
        ...
        /**
         * Testo
         * @description The text of the file, for a reader that cannot open a PDF -- an agent, or a
    ...
    "/api/time-entries/timer": {
        ...
        /**
         * Running Timer
         * @description The caller's own running timer, or `null`. A 200 with `null` rather than a 404:
         *     "no clock running" is the ordinary state of the page that asks, not an error.
         */
        get: operations["running_timer_api_time_entries_timer_get"];
        put?: never;
        post?: never;
        /** Discard Timer */
        delete: operations["discard_timer_api_time_entries_timer_delete"];
        options?: never;
        head?: never;
        /** Update Timer */
        patch: operations["update_timer_api_time_entries_timer_patch"];
        trace?: never;
    };
    "/api/time-entries/timer/start": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /** Start Timer */
        post: operations["start_timer_api_time_entries_timer_start_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/time-entries/timer/stop": {
        ...
        /**
         * Stop Timer
         * @description Stops the clock and answers with the entry it became -- the row now in the
         *     register, with its frozen rate, exactly as `POST /api/time-entries` would return it.
         */
        post: operations["stop_timer_api_time_entries_timer_stop_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/drive/account": {
        ...
        /**
         * Disconnect
         * @description No `elimina_messaggi` flag: Drive stores no correspondence of its own, so there is
         *     nothing here for one to name -- see `GoogleDriveOAuthService.disconnect`.
         */
        delete: operations["disconnect_api_drive_account_delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/api/drive/oauth/start": {
        ...
        /** Start Oauth */
        get: operations["start_oauth_api_drive_oauth_start_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/drive/oauth/callback": {
        ...
        /** Finish Oauth */
        get: operations["finish_oauth_api_drive_oauth_callback_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/drive/account/roots": {
        ...
        /**
         * Update Roots
         * @description No `gmail_configured` gate, on purpose: `set_roots` reaches the row through
         ...
         */
        patch: operations["update_roots_api_drive_account_roots_patch"];
        trace?: never;
    };
    "/api/email-drafts": {
        parameters: {
    ...
    "/api/tenants/root": {
        ...
        /**
         * Root Space
         * @description What the SPA asks under a prefix to learn whether it is the root wearing its own
         *     name -- in which case its login may still offer to create a space.
         */
        get: operations["root_space_api_tenants_root_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/calendario": {
        ...
        /**
         * Month
         * @description One month: the hours by day, the activities falling due, the invoices falling due.
         *
...
export interface components {
    schemas: {
        ...
        AttivitaPage: {
            /** Items */
            items: components["schemas"]["AttivitaRead"][];
            /** Next Cursor */
        ...
        AttivitaRead: {
             ...
             * @enum {string}
             */
            origine: "manuale" | "automazione" | "sollecito";
            /** Regola */
            regola: string | null;
            /** Custom Fields */
            custom_fields: {
        ...
        AttivitaUpdate: {
            ...
            /**
             * Scadenza Da Rimuovere
             * @default false
             */
            scadenza_da_rimuovere: boolean;
            /**
             * Riferimento Da Rimuovere
             * @default false
             */
            riferimento_da_rimuovere: boolean;
        };
        ...
        /**
         * CalendarDay
         * @description One day that has something on it.
         *
        ...
        CalendarDay: {
            ...
            ore: string;
            /** Per Deal */
            per_deal?: components["schemas"]["DayDealHours"][];
            /** Attivita */
            attivita?: components["schemas"]["AttivitaRead"][];
            /** Fatture */
            fatture?: components["schemas"]["DueInvoice"][];
        };
        /**
         * CalendarMonth
         * @description One month, in one read.
         *
        ...
        CalendarMonth: {
            ...
            ore_totali: string;
            /** Giorni */
            giorni?: components["schemas"]["CalendarDay"][];
            /** Attivita Senza Scadenza */
            attivita_senza_scadenza?: components["schemas"]["AttivitaRead"][];
        };
        /**
         * CashMonth
        ...
        /**
         * DayDealHours
         * @description The hours of one deal on one day, with the labels a grid needs to draw them.
         *
        ...
        /**
         * DocumentTextRead
         * @description The readable text of one archived document, and the sentence that says whose it is.
         *
        ...
        /**
         * DueInvoice
         * @description An issued, unpaid invoice falling due on a day of the month being read.
         *
        ...
        FieldDefinitionCreate: {
             ...
             * @enum {string}
             */
            entity_type: "customer" | "person" | "deal" | "document" | "invoice" | "time_entry" | "cost" | "attivita";
            /** Key */
            key: string;
            /** Label */
            label: string;
        ...
        /**
         * TimerStart
         * @description What a timer knows when it starts. Everything optional but the intent: a deal
        ...
        /**
         * TimerStop
         * @description What may still be decided at the moment of stopping. `data` is the calendar day the
        ...
        /**
         * TimerUpdate
         * @description Changed while running: the person realises which deal this is, or what to call it.
         */
        TimerUpdate: {
            /** Deal Id */
            deal_id?: string | null;
...
export interface operations {
    ...
    running_timer_api_time_entries_timer_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    discard_timer_api_time_entries_timer_delete: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    update_timer_api_time_entries_timer_patch: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["TimerUpdate"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    start_timer_api_time_entries_timer_start_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    stop_timer_api_time_entries_timer_stop_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    read_account_api_drive_account_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["DriveHealth"];
                };
            };
            /** @description Permesso negato: l'actor non ha il ruolo richiesto. */
            403: {
    ...
    disconnect_api_drive_account_delete: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    start_oauth_api_drive_oauth_start_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    finish_oauth_api_drive_oauth_callback_get: {
        parameters: {
            query?: {
                code?: string | null;
                state?: string | null;
    ...
    update_roots_api_drive_account_roots_patch: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["DriveRootsUpdate"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["GoogleDriveAccountRead"];
                };
            };
            /** @description Permesso negato: l'actor non ha il ruolo richiesto. */
            403: {
    ...
    root_space_api_tenants_root_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["RootSpace"];
                };
            };
            /** @description Permesso negato: l'actor non ha il ruolo richiesto. */
            403: {
    ...
    list_attivita_api_attivita_get: {
        parameters: {
            query?: {
                ...
                deal_id?: string | null;
                invoice_id?: string | null;
                scade_entro?: string | null;
                senza_scadenza?: boolean | null;
                limit?: number;
                cursor?: string | null;
                /** @description created_at | scadenza */
                sort?: string | null;
                dir?: "asc" | "desc";
            };
            header?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AttivitaPage"];
                };
            };
            /** @description Permesso negato: l'actor non ha il ruolo richiesto. */
            403: {
    ...
    create_api_attivita_post: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AttivitaCreate"];
            };
        };
        responses: {
            /** @description Successful Response */
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["AttivitaRead"];
                };
            };
            /** @description Permesso negato: l'actor non ha il ruolo richiesto. */
            403: {
    ...
    update_api_attivita__attivita_id__patch: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AttivitaUpdate"];
            };
        };
        responses: {
            /** @description Successful Response */
