...
> **Il dataset non è più in questo repository.** `docs/superpowers/data/2026-09-04-acme-fatture-2026.json`
...
- `list_invoices` (filtro `anno = 2026`, o senza filtro) deve mostrare le 14 fatture
  importate, tutte con `importata_da = "esterno"` (il valore era `"acme"` fino
