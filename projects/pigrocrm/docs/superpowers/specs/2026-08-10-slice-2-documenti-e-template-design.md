...
Acme faceva già questo, e lo faceva bene sotto un aspetto e male sotto un altro. Il contenuto
...
Tre difetti, tutti dimostrati dal codice di Acme stesso:
...
3. **Non ha escaping.** I valori finiscono non escapati dentro sorgente Typst. Acme ha un commit
...
- **`GDriveStorage`** — service account, una cartella per cliente, esattamente come Acme le crea
  già oggi. Chi migra da Acme ritrova le sue cartelle.
